...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    /**
     * Mengambil daftar semua karyawan aktif yang terdaftar di suatu tenant perusahaan (belum dihapus).
     * @param tenantId ID penyewa/klien perusahaan
     * @param deletedStatus Status hapus (0 = aktif)
     * @return List data karyawan
     */
    List<Employee> findAllByTenantIdAndDeletedStatus(Long tenantId, Integer deletedStatus);
