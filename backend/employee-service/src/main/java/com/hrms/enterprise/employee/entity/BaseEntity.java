...
/**
 * BaseEntity ini bertindak sebagai kelas induk (Base Class) untuk semua entitas database kita.
 ...
 *
 * Catatan Arsitektur:
 * Kita tidak menggunakan fitur 'AuditorAware' dari Spring Data JPA secara sengaja. Hal ini dilakukan
 * agar penentuan siapa yang membuat/mengubah/menghapus data dapat disuplai secara manual dan eksplisit
 * dari Service Layer (berdasarkan data User Session dari JWT/Keycloak), sehingga kode kita transparan
 * dan mudah dilacak alurnya tanpa ada proses ajaib ("magic") di latar belakang.
 */
@MappedSuperclass
@Getter
@Setter
