 ...
 * Relasi JPA seperti @ManyToOne ke Department atau Job tidak digunakan secara sengaja.
 * Sebagai gantinya, penyimpanan ID departemen (departmentId) dan ID posisi jabatan (jobId)
 * dilakukan secara manual bertipe data Long. Hal ini penting untuk memastikan domain bisnis employee-service
